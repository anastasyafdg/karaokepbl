...
<main class="container mx-auto px-4 py-8 max-w-6xl">
    ...
    <form action="{{ route('reservasi.store') }}" method="post" class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="bg-white p-6 lg:p-8 rounded-xl shadow-sm border border-gray-100 flex-1">
            ...
            <button type="submit" class="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 mt-8 py-3.5 rounded-lg font-semibold text-white shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center">
...
<script>
    ...
    function hitungDurasi(waktuMulai, waktuSelesai) {
        ...
        return Math.max(0, (totalMenitSelesai - totalMenitMulai) / 60);
    }
